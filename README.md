# Integration der Lemo2 Activity Time Analyse-Demo in das Dropwizard-Example.
# Die Installation erfolgt nach der Dropwizard-Anleitung weiter unten.
# Der Aufruf erfolgt mit http://localhost:8080/views/activityTime
# Introduction
